...
Eine vollständige Liste der neuen Funktionen und Verbesserungen finden Sie unter link:whats-new-otv-102.html["Neuerungen bei ONTAP Tools für VMware vSphere 10.2"].
